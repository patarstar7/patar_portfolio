...
import project1 from '../assets/images/CS184_Project.png';
import project2 from '../assets/images/CS169_Project.jpg';
              ...
              <div className="bg-black text-center h-100 project">
                <div className="d-flex h-100">
                  <div className="project-text w-100 my-auto text-center text-lg-right">
                    ...
                    <p className="mb-0 text-white-50">
                      In a group of 6, we worked with a local company, FuelEd Schools, to implement a scheduling system for to help
                      facilitate the meetings with their students.
                    </p>
                    <p className="mb-0 text-white-50">
